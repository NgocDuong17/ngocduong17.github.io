...
<div class="project-wrap">
  <button class="collapsible">Enterprise BI Pipeline: ETL with SSIS, OLAP Cube with SSAS, and Live Power BI Dashboard | 2025</button>
  <div class="content">
    <p><a href="https://github.com/NgocDuong17/SQL-BI-Dashboard-Project/blob/master/README.md" target="_blank">Link to project</a></p>
    <ul>
